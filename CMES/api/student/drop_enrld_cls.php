<?php
    ...
    if($student->drop_enrld_cls($class_course_id, $class_num)) {
        echo json_encode(
            array('message'=> 'Student enrolled class successfully dropped')
        );
    } else {
        echo json_encode(
            array('message'=> 'Student enrolled class could not be dropped')
        );
    }