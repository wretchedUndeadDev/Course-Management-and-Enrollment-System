<?php
    ...
    if($student->drop_wtlstd_cls($class_course_id, $class_num)) {
        echo json_encode(
            array('message'=> 'Student waitlisted class successfully dropped')
        );
    } else {
        echo json_encode(
            array('message'=> 'Student waitlisted class could not be dropped')
        );
    }