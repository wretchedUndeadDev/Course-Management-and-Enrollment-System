...
<html>
    <head>
        ...
        <title>Course Management and Enrollment System | Student | Shopping Cart</title>
            ...
            <div id="mainContentContainer">
                <header>
                    <div class="card text-white bg-primary mb-3">
                        <h1 id="mainTitle1">Shopping Cart</h1>
                    </div>
                </header>
                <hr id="line1">
                    ...
                    <div id="courseSelectionCard" class="card text-white bg-success mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div id="bottomButtonContainer">
                                ...
                                <button class="btn btn-danger">Request Courses</button>
                            </div>
                        </div>
                    </div>
