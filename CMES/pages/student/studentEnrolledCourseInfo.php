<?php
    ...
    if (isset($_COOKIE['student_id'])) {
        ...
        if (isset($_POST['Details'])) {
            $course_id = $_POST['Details'];

            //Call api and get students enrolled course information
            $student_enrolled_course_classes = json_decode(file_get_contents(ROOT_URL.'api/student/get_enrld_crs_cls.php?student_id='.$student_id.'&course_id='.$course_id.''));
